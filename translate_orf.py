#!/bin/python3
#Python Translation Project - Part 2
import sys
import translate
...
def main():
    ...
    # use the defaults.
     ...
     #Added code to translate the first ORF found. 
     #Still Outputting the original nucleotide sequence to show what the amino acid sequence was translated from. 
     translation = translate_sequence(rna_sequence = orf, genetic_code = genetic_code)
     sys.stdout.write('{}\n'.format(translation))
